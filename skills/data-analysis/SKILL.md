...
description: >
    ...
    Covers exploratory analysis, hypothesis testing, segmentation, anomaly detection, 
    and storytelling from data. Do NOT use for simple data reading/extraction, file 
    format conversion, or charting without interpretive analysis.
---
